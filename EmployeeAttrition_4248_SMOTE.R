...
prunedTree <- prune.misclass(baselineTree, best=18)
plot(prunedTree, type="uniform")
text(prunedTree, pretty=3, cex=0.6)
summary(prunedTree)
...
which.min(testerr_bag) # 33
min(testerr_bag)
which.min(OOBerr_bag) # 14 
min(OOBerr_bag)

plot(Bval, testerr_bag, type="l", ylim = c(0.10, 0.35),
...
legend(2500, 0.32, legend=c("single tree", "test error", "OOB error"),
       col=c("seagreen", "black", "blue"), lty=c(2,1,1), cex=0.75, lwd=2, y.intersp=0.3)
...
plot(Bval, testerr_rf[,1], type="l", ylim=c(0.12, 0.35),
...
legend(2500, 0.32, legend=c("RF(m=5)", "RF(m=15)", "Bagging", "Single Tree"),
       col=c("blue", "red", "black", "seagreen"), lty=c(1,1,1,2), cex=0.7, lwd=2, y.intersp=0.3)

plot(Bval, 1-testerr_rf[,1], type="l", ylim=c(0.84, 0.89),
     xlab="B", ylab="Accuracy", main="Random forests", col = "blue", lwd=2)
points(Bval, 1-testerr_rf[,2], type="l", col="red", lwd=2)
points(Bval, 1-testerr_bag, type="l", col="black", lwd=2)
abline(h=1-singletesterr, col="seagreen", lwd=2, lty=2)
legend(2500, 0.89, legend=c("RF(m=5)", "RF(m=15)", "Bagging", "Single Tree"),
       col=c("blue", "red", "black", "seagreen"), lty=c(1,1,1,2), cex=0.9, lwd=2, y.intersp=0.3)
...
plot(Bval, testerr_boost[1,], type="l",
     xlab="B", ylab="error", main="Boosted Trees, shrinkage = 0.01", ylim=c(0.10, 0.35), lwd=2)
points(Bval, testerr_boost[2,], type="l", col="red", lwd=2)
abline(h=singletesterr, col="seagreen", lwd=2, lty=2)
legend(2500, 0.3, legend=c("single tree", "d=1", "d=2"),
       col=c("seagreen", "black", "red"), lty=c(2,1,1), cex=0.75, y.intersp=0.3)
...
plot(Bval, testerr_boost2[1,], type="l",
     xlab="B", ylab="error", main="Boosted Trees, shrinkage = 0.1", ylim=c(0.10, 0.35), lwd=2)
...
# For shrinkage = 0.01
which.min(testerr_boost[1,]) # 1
which.min(testerr_boost[2,]) # 1
min(testerr_boost[1,])
min(testerr_boost[2,])

# For shrinkage = 0.1
which.min(testerr_boost2[1,]) # 18
which.min(testerr_boost2[2,]) # 9
...
# For B=4000, d=1, shrinkage=0.01
boostd1s001 <- gbm(Attrition~., data=train2, distribution="bernoulli",
                   n.trees=4000, interaction.depth=1, shrinkage=0.01)
# Variable importance
summary.gbm(boostd1s001)

# For B=4000, d=2, shrinkage=0.01
...
# Metrics of Boosting: B=4000, d=1, shrinkage=0.01
...
# Metrics of Boosting: B=4000, d=2, shrinkage=0.01
...
# For B=4000, d=1, shrinkage=0.1
boostd1s01 <- gbm(Attrition~., data=train2, distribution="bernoulli",
                  n.trees=4000, interaction.depth=1, shrinkage=0.1)
# Variable importance
summary.gbm(boostd1s01)

# For B=4000, d=2, shrinkage=0.1
boostd2s01 <- gbm(Attrition~., data=train2, distribution="bernoulli",
                  n.trees=4000, interaction.depth=2, shrinkage=0.1)
# Variable importance
summary.gbm(boostd2s01)


# Metrics of Boosting: B=4000, d=1, shrinkage=0.1
...
# Metrics of Boosting: B=4000, d=2, shrinkage=0.1
...
# Boosting and Single Tree
plot(Bval, 1-testerr_boost[1,], type="l", ylim=c(0.81, 0.88),
     xlab="B", ylab="Accuracy", main="Boosting", lwd=2)
points(Bval, 1-testerr_boost[2,], type="l", col="red", lwd=2)
points(Bval, 1-testerr_boost2[1,], type="l", col="blue", lwd=2)
points(Bval, 1-testerr_boost2[2,], type="l", col="brown", lwd=2)
abline(h=1-singletesterr, col="seagreen", lty=2, lwd=2)
legend(2000, 0.88, legend=c("d=1,shrinkage=0.01", "d=2,shrinkage=0.01", "d=1,shrinkage=0.1", "d=2,shrinkage=0.1", "Single Tree"),
       col=c("black", "red", "blue", "brown", "seagreen"), lty=c(1,1,1,1,2), cex=0.8, lwd=2, y.intersp=0.3)


# Comparison of Methods
plot(Bval, testerr_boost2[1,], type="l", ylim=c(0.12, 0.35),
...
abline(h=singletesterr, col="seagreen", lwd=2, lty=2)
#legend(1800, 0.30, legend=c("Boosting (d=1, s=0.01)", "RF(m=5)", "Bagging", "Single Tree"),
      #col=c("black", "red", "blue", "seagreen"), lty=c(1,1,1,2), cex=0.6, y.intersp=0.5)
legend(1800, 0.30, legend=c("Boosting (d=1, s=0.1)", "RF(m=5)", "RF(m=15)", "Bagging", "Single Tree"),
       col=c("black", "red", "blue", "brown", "seagreen"), lty=c(1,1,1,1,2), cex=0.7, y.intersp=0.3)

# Comparison of Methods
plot(Bval, 1-testerr_boost2[1,], type="l", ylim=c(0.81, 0.9),
     xlab="B", ylab="Accuracy", main="Comparison of Test Accuracy Between Different Models", lwd=2)
points(Bval, 1-testerr_rf[,1], type="l", col="red", lwd=2)
points(Bval, 1-testerr_rf[,2], type="l", col="blue", lwd=2)
points(Bval, 1-testerr_bag, type="l", col="brown", lwd=2)
abline(h=1-singletesterr, col="seagreen", lwd=2, lty=2)
#legend(1800, 0.30, legend=c("Boosting (d=1, s=0.01)", "RF(m=5)", "Bagging", "Single Tree"),
#col=c("black", "red", "blue", "seagreen"), lty=c(1,1,1,2), cex=0.6, y.intersp=0.5)
legend(1800, 0.9, legend=c("Boosting (d=1, s=0.1)", "RF(m=5)", "RF(m=15)", "Bagging", "Single Tree"),
       col=c("black", "red", "blue", "brown", "seagreen"), lty=c(1,1,1,1,2), cex=0.7, y.intersp=0.3)

# Comparison of ROC curves
par(pty = "s")
final_roc <- plot(roc(y_test,baselineTree.probs[,2]), xlim=c(1,0),col="seagreen")
final_roc <- plot(roc(y_test,bagging4k.probs[,2]), xlim=c(1,0), col="blue",print.auc.y=.4, add=TRUE)
...
final_roc <- plot(roc(y_test2,boostd1s01.probs), xlim=c(1,0), col="black",print.auc.y=.4, add=TRUE)
#legend(0.7, 0.3, legend=c("Boosting (d=1, s=0.1)", "RF(m=5)", "RF(m=15)", "Bagging", "Single Tree"),
       #col=c("black", "red", "blue", "brown", "seagreen"), lty=c(1,1,1,1,2), cex=0.6, y.intersp=0.2, text.width=0.3)
legend(0.7, 0.3, legend=c("Boosting (d=1, s=0.01)", "RF(m=5)", "Bagging", "Single Tree"),
